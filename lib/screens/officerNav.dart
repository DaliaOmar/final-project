// ignore_for_file: import_of_legacy_library_into_null_safe, file_names, unused_import, camel_case_types, non_constant_identifier_names, prefer_const_constructors
...
class _officerNavState extends State<officerNav> {
  ...
  List<TabItem> tabItems = List.of([
    ...
    TabItem(Icons.gps_fixed, "مساري", greenDark,
        labelStyle: TextStyle(
          fontFamily: 'El Messiri',
          fontSize: 15,
          color: Colors.white,
