// ignore_for_file: file_names, camel_case_types, prefer_final_fields, prefer_const_constructors, deprecated_member_use, prefer_const_literals_to_create_immutables, avoid_print, curly_braces_in_flow_control_structures
...
class profileOfficer extends StatefulWidget {
  const profileOfficer({Key? key}) : super(key: key);

  @override
  State<profileOfficer> createState() => _profileOfficerState();
}

class _profileOfficerState extends State<profileOfficer> {
  bool pass = true;
  bool edit = true;
  bool save = false;
  ...
  Widget myData() {
    return FutureBuilder(
      ...
      builder: (context, snapchot) {
        officerModel data = snapchot.data as officerModel;
